package com.example.maykureskent;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buPrecent = findViewById(R.id.buPrecent);
        Button buEquals = findViewById(R.id.buEqually);
        Button buPlus = findViewById(R.id.buPlus);
        Button buMinus = findViewById(R.id.buMinus);
        Button buMul = findViewById(R.id.buMu1);
        Button buDev = findViewById(R.id.buDivision);
        Button buDot = findViewById(R.id.buComma);
        ...
        buPrecent.setOnClickListener(v -> handlePercent());
